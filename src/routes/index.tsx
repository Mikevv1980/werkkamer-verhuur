...
const kamers = [
  ...
  },
  {
    ...
    daily: 95,
    image: k2Wide.url,
    features: ["Max. 2 personen", "Veel daglicht en groen uitzicht", "Rustige en warme sfeer"],
  },
];
        ...
        <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:gap-16">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <img
              ...
              width={800}
              height={900}
              className="h-72 w-full rounded-2xl object-cover sm:h-[456px]"
            />
            <div className="grid gap-4 sm:h-[456px] sm:grid-rows-2">
              <img
                src={omgevingPad.url}
                ...
                width={800}
                height={500}
                className="h-52 w-full rounded-2xl object-cover sm:h-full sm:min-h-0"
              />
              <img
